...
export const getProfilePic = async (userId) => {
    ...
    try {
        ...
        throw new Error(
            `getProfilePic: Fail to retrieve picture from ${fileDir}, picture possibly not exist`
        );
    }
};
...
export const getSamplePic = async (name) => {
    ...
    try {
        ...
        throw new Error(
            `getSamplePic: Fail to get sample picture from ${fileDir}, picture possibly not exist`
        );
    }
    return picUrl;
};
...
export const getOneSticker = async (type, numberId) => {
    ...
    try {
        ...
        throw new Error(
            `getOneSticker: Fail to retrieve sticker from ${fileDir}`
        );
    }
    return picUrl;
};
...
export const getTypeStickers = async (type) => {
    ...
    try {
        ...
        throw new Error(
            `getTypeStickers: Fail to fetch stickers from ${fileDir}`
        );
    }
