import { Avatar, Button, Center, FormControl, Input, Modal } from 'native-base';
...
const EditProfile = ({ navigation, route }) => {
    ...
    const setTempDisplayName = useProfileStore(
        (state) => state.setTempDisplayName
    );
        ...
        <KeyboardAwareScrollView contentContainerStyle={styles.container}>
            ...
            >
                <Modal.Content
                    ...
                    p={2}
                >
                    <Modal.Header bg="#fff" borderBottomWidth="0">
                  Discard changes?
                    </Modal.Header>
